...
export function ProductsDefaultView({
  products,
  pageCount,
  category,
  categories,
            ...
            <div className="flex flex-1 flex-col gap-5 overflow-hidden px-1">
              <div className="space-y-4">
                <h3 className="text-sm font-medium tracking-wide text-foreground">
                  Rango de precio: {numberToClp(`${priceRange[0]}`)} -{" "}
                  {numberToClp(`${priceRange[1]}`)}
                </h3>
                <Slider
                  variant="range"
                  thickness="thin"
              ...
              {categories?.length ? (
                <div className="space-y-4">
                  ...
                  >
                    <MultiSelectorTrigger>
                      <MultiSelectorInput placeholder="Selecciona categorias" />
                    </MultiSelectorTrigger>
                    <MultiSelectorContent>
                      <MultiSelectorList>
